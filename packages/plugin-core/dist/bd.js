...
export function parseSpecRefs(planContent) {
    const refs = [];
...
function extractTaskTitle(content, matchIndex) {
...
async function execBdCommand(command) {
...
export async function createValidTask(description, specRef, priority = 2) {
    try {
...
export async function createImplTask(description, specRef, priority = 2) {
    try {
...
export async function createTestTask(description, specRef, priority = 2) {
    try {
...
export async function addTaskDependency(blockedTaskId, blockingTaskId) {
    try {
...
export async function createTddTaskPair(description, specRef, priority = 2) {
...
export async function findOutputTasksForSpecRef(specRef) {
    return [];
}
export async function generateValidTasksFromPlan(planContent, outputTaskIds) {
